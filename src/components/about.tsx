    ...
    <section id="about" className="py-12 sm:py-24 bg-[#F5F0EB]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="grid md:grid-cols-2 -mt-4 md:mt-0 gap-8 md:gap-12 items-center">
          ...
          >
            <div className="w-full max-w-[320px] overflow-hidden rounded-3xl border border-border shadow-xl">
          ...
          >
            ...
            <motion.p variants={staggerBlurChild} className="text-muted leading-relaxed mb-8">
              在 Bonnie Studio，我堅持專業、安全、用心的服務。自 2021 年創立至今，每一次療程前都會詳細了解你的身體狀況，調整最適合你的手法與力道，讓你在安心的環境中，找回身體的輕盈與舒暢。
            </motion.p>
